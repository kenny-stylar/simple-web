...
@section('content')
  ...
  <div class="form">
    {{ Form::open( array('class'=>'form-horizontal')) }}
      ...
      <div class="form-group">
        {{ Form::label('username', 'Username', array('class'=>'col-lg-2 control-label required')) }}
        <div class="col-lg-10">
      ...
      <div class="form-group">
        {{ Form::label('password_confirmation', 'Confirm Password', array('class'=>'col-lg-2 control-label required')) }}
        <div class="col-lg-10">
